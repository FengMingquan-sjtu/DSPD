...
def getArgs():
    ...
    parser.add_argument('--feature_size', type=int, default=64,help="num of channels of feature map")
    parser.add_argument('--num_ResBlock', type=int, default=16,help="num of ResBlock in model")
